...
const variantLabels: Record<BadgeVariant, string> = {
  ...
  follow_up_1: "Acompanhar",
  follow_up_2: "Acompanhar",
  follow_up_3: "Acompanhar",
  nao_respondeu_follow_up: "Sem retorno",
  inicio_atendimento: "Novo contato",
  conversando: "Em contato",
  cancelou_agendamento: "Cancelado",
  abandonou_conversa: "Sem retorno",
  admin: "Admin",
  user: "Usuário",
  ativo: "Ativo",
